  ...
  "Large Beneficiary Extractor" - {
    ...
    "when there are large beneficiaries" - {
      ...
      "with minimum data must return user answers updated" in {
        ...
        extraction.right.value.get(LargeBeneficiaryNumberOfBeneficiariesPage(0)).get mustBe Over1001
      }
      ...
      "with full data must return user answers updated" in {
        ...
        extraction.right.value.get(LargeBeneficiaryNumberOfBeneficiariesPage(1)).get mustBe Over1001
